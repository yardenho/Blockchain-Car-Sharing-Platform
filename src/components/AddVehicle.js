...
class AddVehicle extends Component {
    ...
    render() {
        const splitDates = () => {
            if (this.state.unavilableDates !== "") {
                let dates = this.state.unavilableDates.split("#");
        ...
        const check_date_overlap = (start, end) => {
            ...
            const dates = this.state.unavilableDates;
            let datesList = [];
            if (dates !== "") {
            ...
            <div id="content">
                ...
                <form
                    onSubmit={(event) => {
                        ...
                        let li = this.state.unavilableDates;
                        ...
                        <div>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    console.log(this.state.unavilableDates);
                                }}
                            >
                                {" "}
                                Add another range
