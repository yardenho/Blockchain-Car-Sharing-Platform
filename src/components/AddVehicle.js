...
class AddVehicle extends Component {
  ...
  render() {
    ...
    return (
      <div style={{ marginTop: "40px", marginLeft: "450px" }} id="content">
        <h1 style={{ marginLeft: "120px" }}>Add Vehicle</h1>
        <form
          onSubmit={(event) => {
            ...
            const gasType = this.state.gasType;
        ...
        >
          <div className="form-group mr-sm-2">
            ...
            <div>
              <label>
                Pick the vehicle's gas type:{" "}
                <select
                  name="gasType"
                  value={this.state.gasType} // ...force the select's value to match the state variable...
                  onChange={(e) =>
                    this.setState({
