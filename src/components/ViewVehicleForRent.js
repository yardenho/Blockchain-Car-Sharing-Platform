...
const ViewVehicleForRent = (props) => {
    ...
    const testRentData = () => {
        ...
        console.log(props.account.toString().toLowerCase());
        console.log(location.state.vehicle.owner.toString().toLowerCase());
        ...
        <div>
            ...
            <form
                onSubmit={(event) => {
                    ...
                    const rentPrice = window.web3.utils.toWei(
                        price.toString(),
                        "Ether"
                    );
                ...
                >
                    ...
                    >
                        ...
                        >
                            <span>
                                Gear box type:{" "}
                                {location.state.vehicle.gearboxType}
                            </span>
                        </div>
